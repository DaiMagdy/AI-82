from student.system import SysemManager  # Import the main manager class to handle students and courses
...
def core():
    manager = SysemManager()  # Initialize the system manager instance
    while True:
